...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig_ranasinghe2019_visualizations.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig_burigat2011_navigation_uncertainty.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig_mckenzie2016_blue_dot_variants.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig_hegarty2016_location_judgment_displays.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig_lodha2002_gps_uncertainty_gis.png}
    \caption{Example of spatio-temporal GPS uncertainty visualization within a GIS environment \cite{lodha2002visualization}.}
    \label{fig:lodha2002}
\end{figure}

\subsection{Use of Gemini Deep Research Output}

The Gemini-generated research output should be treated as a \textbf{secondary synthesized source} rather than a primary publication. It may still be useful for identifying themes, candidate references, or terminology related to uncertainty-aware visualization.

\gemininote{If a section is based on the Gemini Deep Research output, it should be explicitly labeled as such, and important claims should ideally be traced back to original academic publications before they are used as core evidence in the final version.}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=0.95\columnwidth]{directional-edge.jpeg}
    ...
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=0.95\columnwidth]{aeral-density.jpeg}
